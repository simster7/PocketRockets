...
class GameState:
    ...
    def start_hand(self, players, big_blind, small_blind, deck, starting_pot=0):
    ...
    def end_game(self):
        ...
        if sum(self.fold_vector) == len(self.players) - 1:
            ...
            print("Other showdown hands:", ", ".join([self.players[r_hand.player_index].name + " had a " + r_hand.hand_name for r_hand in losers]))
        return self
